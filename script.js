...
const fallbackProducts = [
  { name:"Black Storm Shell", category:"Jackets", size:"L", condition:"Rare", price:"R1,250", status:"Available", image:"https://images.unsplash.com/photo-1551028719-00167b16eac5?auto=format&fit=crop&w=900&q=90", description:"A dark technical shell with a clean shape and sharp presence." },
  { name:"Grape Puffer", category:"Puffers", size:"XL", condition:"Excellent", price:"R1,650", status:"Available", image:"https://images.unsplash.com/photo-1591047139829-d91aecb6caea?auto=format&fit=crop&w=900&q=90", description:"Soft volume, winter weight, and a colour that does the talking." },
  { name:"Vintage Convert Jacket", category:"Jackets", size:"L", condition:"Vintage", price:"R950", status:"Available", image:"https://images.unsplash.com/photo-1520975954732-35dd22299614?auto=format&fit=crop&w=900&q=90", description:"An everyday outer layer with the kind of wear that feels earned." },
  { name:"Pink Tech Layer", category:"Streetwear", size:"M", condition:"90s", price:"R1,100", status:"Available", image:"https://images.unsplash.com/photo-1603252109303-2751441dd157?auto=format&fit=crop&w=900&q=90", description:"Bright, clean, and built for someone who knows exactly what they found." }
];
...
function normaliseProduct(product){
  return {
    ...
    description: product.description || "A handpicked baadjie piece with character.",
